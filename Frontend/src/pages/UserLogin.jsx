...
const UserLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    sessionStorage.setItem("userId", data.user.id); // 🔥 REQUIRED
    sessionStorage.setItem("userEmail", data.user.email); // (optional, useful)
      ...
      <div className="w-96">
        ...
        <p className="text-center mt-4 text-sm">
          ...
          <span
            ...
            onClick={() => navigate("/api/auth/user-register")}
          >
            Register here
          </span>
        </p>
